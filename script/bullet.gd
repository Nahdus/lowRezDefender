...
var path_finders = ["pathfinder22","pathfinder67","pathfinder112","pathfinder157","pathfinder202"]
#							[Vector2(47,0),Vector2(64,18),Vector2(64,46),Vector2(46,63),Vector2(17,64),Vector2(0,46),Vector2(0,18),Vector2(17,0)]
var bullet_despawn_points = [Vector2(46,0),Vector2(63,18),Vector2(63,45),Vector2(46,63),Vector2(17,63),Vector2(0,46),Vector2(0,18),Vector2(17,0)]
var position_offset = [Vector2(0,0),Vector2(1,0),Vector2(1,0),Vector2(1,1),Vector2(1,1)]
var path_index = 0
